  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button sx={getButtonStyle("/adminprofile")} onClick={() => navigate("/adminprofile")}>
          Profile
        </Button>
            ...
            >
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={12} md={3}>
                  ...
                  <Typography fontWeight="bold">{b.venue}</Typography>
                ...
                <Grid item xs={12} md={3}>
                  ...
                  <Typography fontWeight="bold">{b.bookedBy}</Typography>
                  <Typography variant="caption">Total Cost</Typography>
                  <Typography>{b.totalCost}</Typography>
                </Grid>
                ...
                <Grid item xs={12} md={2} textAlign="center">
                  <Chip
                    ...
                    sx={{
                      backgroundColor:
                        b.paymentStatus === "Processing" ? "#00e5ff" : "#4caf50",
                      color: "black",
                      fontWeight: "bold",
                    }}
                  />
