...
const Organizers = () => {
  ...
  const fetchOrganizers = async () => {
    ...
    try {
      ...
      const res = await axiosClient.get("/admin/organizers", {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button onClick={() => navigate("/adminprofile")} sx={getButtonStyle("/adminprofile")}>
          Profile
        </Button>
            ...
            <TableBody>
              {organizers.map((org, index) => (
                <TableRow key={org.id}>
                  ...
                  <TableCell sx={{ fontWeight: "bold", color: "#00695c" }}>
                    {org.role}
                  </TableCell>
                  <TableCell>
